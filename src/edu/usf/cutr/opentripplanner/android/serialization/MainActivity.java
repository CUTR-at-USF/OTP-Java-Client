...
//				"&mode=WALK,TRAM,SUBWAY,RAIL,BUS,FERRY,CABLE_CAR,GONDOLA,FUNICULAR,TRANSIT,TRAINISH,BUSISH";
		...
		requestUrls[2] = "http://maps5.trimet.org/opentripplanner-api-webapp/ws/plan?optimize=QUICK&showIntermediateStops=true&time=04:34pm&arriveBy=false&wheelchair=false&maxWalkDistance=1600.0&fromPlace=45.483243%2C+-122.735824&toPlace=45.517895%2C+-122.686386&date=11/20/12&mode=WALK,TRAM,SUBWAY,RAIL,BUS,FERRY,CABLE_CAR,GONDOLA,FUNICULAR,TRANSIT,TRAINISH,BUSISH";
...
//		String baseUrl = "http://mapserv.askmorgan.net:8080/opentripplanner-api-webapp/ws/plan";
	...
	public void onTripBatchRequestComplete(Response[] responses) {
		...
		Log.d(TAG, "Batch Results = " + countSuccesses + " out of " + responses.length + " passed");
	}
}